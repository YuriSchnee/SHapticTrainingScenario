...
namespace jp.co.jetman.utils
{
    ...
    public class Fade
    {
        ...
        #region Event
        public event FadeEventHandler fadeEventHandler;
        protected virtual void OnFadeEvent(FadeEventArgs _e)
        {
            if (fadeEventHandler != null)
            {
                fadeEventHandler(this, _e);
            }
        }
        #endregion
        ...
        public void Update(float _deltaTime)
        {
            if (isAnim)
            {
                ...
                if (!isAnim)
                {
                    OnFadeEvent(new FadeEventArgs(FadeEvent.Complete));
                }
            }
        }
